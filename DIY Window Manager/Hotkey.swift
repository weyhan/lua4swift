...
private let lazilySetupKeycodes: () = Carbon.Keycode.setup()
private let lazilySetupHotkeys: Void = SDegutisSetupHotkeyCallback(Carbon.Hotkey.callback)

private typealias chk = Carbon.Hotkey // because otherwise swift crashes
